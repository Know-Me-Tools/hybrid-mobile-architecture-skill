  ...
  return (
    <div data-slot="aui_thread-list-search" className="relative px-0.5 py-1">
      ...
      <Input
        ...
        className={cn("h-9 border-0 bg-[color:var(--color-surface)] ps-8 text-sm shadow-none focus-visible:bg-[color:var(--color-card-hov)] focus-visible:ring-0", className)}
        {...props}
      />
    </div>
  );
  ...
  return (
    ...
    >
      <ThreadListItemPrimitive.Trigger
        ...
        className="flex h-full min-w-0 flex-1 items-center rounded-md px-2.5 text-start text-sm outline-none group-hover:pe-9 group-has-focus-visible:pe-9 group-has-data-[state=open]:pe-9 group-data-active:pe-9 focus-visible:bg-[color:var(--color-card-hov)]"
      >
        <span
  ...
  return (
    <ThreadListItemMorePrimitive.Root sharedFocusGroup>
      ...
      <ThreadListItemMorePrimitive.Content
        ...
        className="bg-popover/95 text-popover-foreground data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=closed]:animate-out data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-32 overflow-hidden rounded-xl border-0 p-1.5 shadow-none backdrop-blur-sm"
      >
