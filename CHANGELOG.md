...
- `references/tauri/patterns.md` — Zustand 5, TanStack Query/Router/Table, IPC patterns, strict layer contract
...
- `scripts/scaffold-tauri.sh` — Tauri + React 19 + Zustand + TanStack + shadcn/ui + feature architecture
...
- Zustand 5 + TanStack Query/Router/Table strict layer contract
