# 2026-07-15-c008-docs-refs-correction

> Phase: scaffold-full-hybrid-project · Wave: see plan.md · Status: proposed
> Assigned harness/model: kimi-code-cli / k2.6
> Depends on: none

## Why

Doc corrections (pglite-oxide reality) + Riverpod 3/SurrealDB 3 refs + features-first testing.md + compile-speed.md
